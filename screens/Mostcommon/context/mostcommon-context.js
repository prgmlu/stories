...
export const MostcommonContextProvider = props => {
	const [state, dispatch] = useReducer(reducer, initialState);
	return (
		<MostcommonContext.Provider value={[state, dispatch]}>
		{props.children}
	</MostcommonContext.Provider>
		);
};
